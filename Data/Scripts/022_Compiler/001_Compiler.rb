...
def pbCompileAllData(mustCompile)
  ...
  if mustCompile
    ...
    # CHANGED: Depends on PBDisguises
    yield(_INTL("Compiling disguise data"))
    pbCompileDisguises
    # CHANGED: Depends on PBQuests
...
def pbCompiler
  ...
  begin
    dataFiles = [
       "berry_plants.dat",
       "disguises.dat", # CHANGED: Included disguises.dat
       "encounters.dat",
       "form2species.dat",
       "items.dat",
       "map_connections.dat",
       ...
       "moves.dat",
       "phone.dat",
       "quests.dat", # CHANGED: Included quests.dat
       "regional_dexes.dat",
       "shadow_movesets.dat",
       "species.dat",
    ...
    textFiles = [
       ...
       "berryplants.txt",
       "connections.txt",
       "disguises.txt", # CHANGED: Included disguises.dat
       "encounters.txt",
       "items.txt",
       "metadata.txt",
       "moves.txt",
       ...
       "pokemon.txt",
       "pokemonforms.txt",
       "quests.txt", # CHANGED: Included quests.txt
       "shadowmoves.txt",
       "tm.txt",
       "townmap.txt",
       "trainerlists.txt",
