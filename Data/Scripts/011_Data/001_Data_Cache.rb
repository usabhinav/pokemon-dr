...
class PokemonTemp
  ...
  attr_accessor :disguiseData # CHANGED: Disguise Data
  attr_accessor :questsData   # CHANGED: Quests Data
end
...
def pbClearData
  if $PokemonTemp
    ...
    $PokemonTemp.disguiseData          = nil # CHANGED: Clears Disguise Data
    $PokemonTemp.questsData            = nil # CHANGED: Clears Quests Data
  end
...
#===============================================================================
# CHANGED: Method relating to disguise data.
#===============================================================================
def pbLoadDisguiseData
  $PokemonTemp = PokemonTemp.new if !$PokemonTemp
  if !$PokemonTemp.disguiseData
    $PokemonTemp.disguiseData = load_data("Data/disguises.dat") || []
  end
  return $PokemonTemp.disguiseData
end

#===============================================================================
# CHANGED: Method relating to quests data.
#===============================================================================
def pbLoadQuestsData
  $PokemonTemp = PokemonTemp.new if !$PokemonTemp
  if !$PokemonTemp.questsData
    $PokemonTemp.questsData = load_data("Data/quests.dat") || []
  end
  return $PokemonTemp.questsData
end
