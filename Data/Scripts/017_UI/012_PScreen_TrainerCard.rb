class PokemonTrainerCard_Scene
  ...
  def pbTrainerCard
    ...
    loop do
      ...
      # CHANGED: Show Zygarde summary screen
      if Input.trigger?(Input::C) && $game_switches[Z_TRANSFORM_SWITCH]
        oldsprites = pbFadeOutAndHide(@sprites)
        sscene = PokemonSummary_Scene.new
        sscreen = PokemonSummaryScreen.new(sscene)
