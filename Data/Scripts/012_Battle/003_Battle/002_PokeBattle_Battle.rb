...
class PokeBattle_Battle
  ...
  attr_accessor :canRecruit       # CHANGED: Whether the player can recruit or not
  attr_accessor :recruitChance    # CHANGED: Base recruit chance
  ...
  def initialize(scene,p1,p2,player,opponent)
    ...
    @endOfRound        = false
    @moldBreaker       = false
    @canRecruit        = true  # CHANGED: Initialized canRecruit
    @recruitChance     = 80    # CHANGED: Initialized recruitChance
    @runCommand        = 0
    @nextPickupUse     = 0
