...
# * The max karma (positive or negative) that the player can reach.
#===============================================================================
MAXIMUM_LEVEL        = 100
EGG_LEVEL            = 1
SHINY_POKEMON_CHANCE = 8
POKERUS_CHANCE       = 3
MAXIMUM_KARMA        = 500 # CHANGED: Constant for max karma
...
# * The fee for Pokemon Storage withdrawal/deposit.
# * The fee for Item Storage withdrawal/deposit.
#===============================================================================
INITIAL_MONEY        = 3000
MAX_MONEY            = 999_999
MAX_COINS            = 99_999
MAX_PLAYER_NAME_SIZE = 10
POKE_STORAGE_FEE     = 300 # CHANGED: Constant for pokemon micro-transaction fee
ITEM_STORAGE_FEE     = 250 # CHANGED: Constant for item micro-transaction fee
...
def pbDexNames; return [
  ...
  # CHANGED: Changed name to Journal
  _INTL("Journal")
]; end
...
# * Array of map IDs that Zyree can't enter without a disguise on.
# * Array of map IDs that player can't save on.
#===============================================================================
...
DISGUISE_EXCLUSIVES = [36, 37] # CHANGED: Used when disguise breaks
SAVE_DISABLED_MAPS = [] # CHANGED: Used to check if save option should be shown or not
...
# * The Global Switch which, while ON, shows the karma bar on the top left.
# * The Global Switch which, while ON, allows Zyro or Zyree to transform into
#      the Zygarde form during battle.
#===============================================================================
...
SHOW_KARMA_SWITCH         = 71 # CHANGED: Karma Bar Switch
Z_TRANSFORM_SWITCH        = 100 # CHANGED: Z-Transform Switch
