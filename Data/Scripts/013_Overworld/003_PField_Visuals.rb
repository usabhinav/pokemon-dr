...
# CHANGED: Commented out default pbStartOver
=begin
...
# CHANGED: Wrote a different version of pbStartOver
def pbStartOver(gameover=false)
  pbMessage(_INTL("\\w[]\\wm\\c[8]<ac>GAME OVER!</ac>"))
  pbCancelVehicles
  pbRemoveDependencies
  $game_temp.player_new_map_id    = 12
