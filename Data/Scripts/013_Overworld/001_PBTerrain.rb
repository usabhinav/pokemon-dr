...
module PBTerrain
  ...
  Bridge          = 15
  Puddle          = 16
  Fishable        = 17 # CHANGED: New terrain tag for Zygarde fishing
  ...
  # CHANGED: Method to check for Zygarde fishing tag
  def self.isFishable?(tag)
    return tag == PBTerrain::Fishable
  end
end
