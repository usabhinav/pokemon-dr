...
# before Main), and name it "Event Export".
# 
#-------------------------------------------------------------------------------
# SCRIPT USAGE
#-------------------------------------------------------------------------------
...
# TROUBLESHOOTING
#-------------------------------------------------------------------------------
# - Sometimes if you copy events or event commands, especially across different
#   projects, the parameters associated with the event commands get copied
#   incorrectly, and as a result this script may crash because it's reading
#   invalid data. If you do get an error while running this script, go to the
#   very last line of the file this script was trying to write to. If you
#   see an event command there, then find that event command in the main RMXP
#   editor and look one command down - that command might be causing you issues.
#   Of course, if you can't find any such command, then feel free to report
...
# Main switch to export events or not upon running game
EXPORTEVENTS = true

# Names files according to timestamp: Year-Month-Date-HoursMinutesSeconds
# Ex. 2020-07-01-163851.txt
